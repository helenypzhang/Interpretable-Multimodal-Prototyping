...
from .attention import multi_head_attention_forward, NystromAttention
...
class LRBilinearFusion(nn.Module):
    ...
    def forward(self, vec1, vec2):
        ...
        _o1 = torch.cat((torch.ones(1, 1, dtype=DTYPE, requires_grad=False), o1), dim=1)
        _o2 = torch.cat((torch.ones(1, 1, dtype=DTYPE, requires_grad=False), o2), dim=1)
