...
class Datum:
    ...
    def __init__(self, patientid="", impath="", molpath="", label=0,  classname="", survival=None):
...
class TCGA_Glioma_S_UMEML(DatasetBase):
    ...
    def _read_data(self, meta_folder, bag_folder, mol_folder, fold=0):
        ...
        train_meta_path = osp.join(meta_folder, f'survival_train_{fold}.csv')
        val_meta_path = osp.join(meta_folder, f'survival_test_{fold}.csv')
