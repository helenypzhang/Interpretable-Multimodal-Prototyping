...
from ..base_dataset import DatasetBase, check_isfile
...
class TCGA_Glioma_C_UMEML(DatasetBase):
    """TCGA_Glioma classification.
    ...
    def __init__(self, cfg):
        ...
        self._meta_folder = osp.join(self.dataset_dir, "labels/classification") 
        ...
        classnames_dict = {0:"G4 GBM", 1:"G4 Astro", 2:"G3 Astro", 3:"G2 Astro", 4:"G3 Oligo", 5:"G2 Oligo"}
    ...
    def _read_data(self, meta_folder, bag_folder, mol_folder, fold=0):
        ...
        train_meta_path = osp.join(meta_folder, f'classification_train_{fold}.csv')
        val_meta_path = osp.join(meta_folder, f'classification_test_{fold}.csv')
