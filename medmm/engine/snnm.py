...
class SNNM(Trainer):
    ...
    def build_model(self):
        ...
        self.model = SNNM_NET(cfg, classnames)
    ...
    def test(self, split=None):
        ...
        if self.cfg.TASK.NAME == "Survival":
            for batch_idx, batch in enumerate(tqdm(data_loader)):
                ...
                hazards, S, logits = self.model_inference(omic)
            ...
            for batch_idx, batch in enumerate(tqdm(data_loader)):
                ...
                output = self.model_inference(omic)
