...
if __name__ == "__main__":
    ...
    parser.add_argument("--umeml_gan_test_without_omic_ratio", type=float, default=0)
    parser.add_argument("--umeml_gan_test_insample_without_omic_ratio", type=float, default=0)
